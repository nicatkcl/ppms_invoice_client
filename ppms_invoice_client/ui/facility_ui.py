...
# Form implementation generated from reading ui file 'ppms_invoice_client\ui\facility.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.manager_email, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.facility_name, 1, 1, 1, 1)
        ...
        self.facility_code = QtWidgets.QLineEdit(Dialog)
        self.facility_code.setObjectName("facility_code")
        self.gridLayout.addWidget(self.facility_code, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "Facility account code"))
